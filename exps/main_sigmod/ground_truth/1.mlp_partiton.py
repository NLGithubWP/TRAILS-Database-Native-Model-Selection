...
all_trained = read_json("./exps/main_sigmod/ground_truth/sampled_models_10000_models.json")
all_model_id = read_json("./exps/main_sigmod/ground_truth/sampled_models_all.json")
