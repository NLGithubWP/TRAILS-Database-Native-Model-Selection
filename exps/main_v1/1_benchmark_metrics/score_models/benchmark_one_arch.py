...
def parse_arguments():
    ...
    # job config
    parser.add_argument('--metrics_result', type=str, default="result.json", help="metrics_result")

    # job config
    parser.add_argument('--num_arch', type=int, default=2, help="how many architecture to evaluate")

    # define base dir, where it stores apis, datasets, logs, etc,
    parser.add_argument('--base_dir', type=str, default="../trails/data",
...
if __name__ == '__main__':
    ...
    try:
        while True:
            ...
            for evaluator_name, evaluator in evaluator_dict.items():
                ...
                new_arch = used_search_space.copy_architecture(int(arch_id), _)
                ...
                try:
                    ...
                    if "out of memory" in str(e):
                        ...
                        eva_time = time.time()
                        new_arch_cpu = used_search_space.copy_architecture(int(arch_id), new_arch.cpu()).cpu()
    ...
    with open('./Logs/'+args.metrics_result, 'w') as outfile:
