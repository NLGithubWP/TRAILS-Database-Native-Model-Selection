...
def seq_train_all_params(parser):
    ...
    parser.add_argument('--pre_partitioned_file',
                        default="./exps/main_v2/ground_truth/sampled_models_10000_models.json",
...
def tune_interval_NK_rate(parser):
    ...
    parser.add_argument('--saved_result',
        default="./exps/main_v2/analysis/result/res_end_2_end_criteo_100_12.json",
        type=str, help='num GPus')
    parser.add_argument('--img_save_path',
        default="./exps/main_v2/analysis/",
        type=str, help='num GPus')
    parser.add_argument('--use_prue_score', default=False, type=bool, help='num GPus')
...
def parse_arguments():
    ...
    parser.add_argument('--budget', type=int, default=100, help="Given budget, in second")
