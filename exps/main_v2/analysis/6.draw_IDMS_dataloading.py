...
rects2 = ax.bar(index, [time_usage[dataset][1] for dataset in datasets], bar_width,
                alpha=opacity, color=colors[1], hatch=hatches[1], edgecolor='black', label='TRAILS-Engine')
...
fig.savefig("./exps/main_v2/analysis/IDMS_dataloading_latency.pdf", bbox_inches='tight')
