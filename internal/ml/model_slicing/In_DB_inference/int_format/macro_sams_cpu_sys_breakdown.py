...
datasets_result = {
    'Adult': {
        'In-Db-opt': {'diff': -0.007969393999999852, 'mem_allocate_time': 0.007871151, 'model_init_time': 0.006836045,
                      'data_query_time': 0.290609444, 'python_compute_time': 0.624381187,
    ...
    'Disease': {
        'In-Db-opt': {'diff': -0.0067551480000001, 'data_query_time_spi': 0.073574947, 'model_init_time': 0.006799476,
                      ...
                      'data_query_time': 0.262377945, 'overall_query_latency': 1.7790125190000001,
    ...
    'Bank': {
        'In-Db-opt': {'data_query_time_spi': 0.068415319, 'model_init_time': 0.006328437,
                      'data_query_time':  0.310727398, 'mem_allocate_time': 0.009163106,
...
for dataset, valuedic in datasets_result.items():
    ...
    T1 = in_db_data_query + in_db_data_copy_start_py + in_db_data_preprocess + in_db_data_model_load + in_db_data_compute
    ...
    T2 = out_db_data_query + in_db_data_model_load + out_db_data_preprocess + out_db_data_compute
