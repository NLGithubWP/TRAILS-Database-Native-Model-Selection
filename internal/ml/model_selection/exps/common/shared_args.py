...
def tune_interval_NK_rate(parser):
    ...
    parser.add_argument('--saved_result',
                        default="./internal/ml/model_selection/exps/result/res_end_2_end_criteo_100_12.json",
                        type=str, help='num GPus')
    parser.add_argument('--img_save_path',
                        default="./internal/ml/model_selection/exps/result/",
                        type=str, help='num GPus')
...
def parse_arguments():
    ...
    parser.add_argument('--result_dir', default="./internal/ml/model_selection/exps/result/", type=str,
