...
def parse_arguments():
    ...
    parser.add_argument('--save_file_latency', type=str,
                        default="./1wk_1run_NB101_c10_latency", help="search target")
    parser.add_argument('--save_file_all', type=str,
                        default="./1wk_1run_NB101_c10_all", help="search target")
    ...
    parser.add_argument('--num_labels', type=int, default=120, help='[10, 100, 120]')
...
if __name__ == "__main__":
    ...
    from query_api.query_train_baseline_api import post_processing_train_base_result, get_base_annotations
    ...
    draw_graph(
        y_acc_list_arr, budget_array, y_acc_list_arr_p1, budget_array_p1,
