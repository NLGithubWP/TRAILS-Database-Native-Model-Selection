...
data = {
    ...
    "DNN+Frappe": [0.45, 0.61, -0.77, 0.54, 0.13, 0.48, -0.27, 0.68, 0.80, 0.77],
    "DNN+UCI": [0.39, 0.63, -0.56, 0.37, 0.31, 0.21, -0.23, 0.62, 0.76, 0.68],
    "DNN+Criteo": [0.32, 0.69, -0.66, 0.46, 0.01, 0.41, -0.18, 0.78, 0.77, 0.74],
