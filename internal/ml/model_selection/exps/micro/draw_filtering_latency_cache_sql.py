...
datasets_cpu = {
    'Frappe': {
        'in_db': './internal/ml/model_selection/exp_result_sever_cache_sql_indb_b64/'
                 '/time_score_mlp_sp_frappe_batch_size_32_cpu_jacflow.json',
        'out_db': './internal/ml/model_selection/exp_result_sever_cache_sql_b64/'
                  '/time_score_mlp_sp_frappe_batch_size_64_cpu_jacflow.json'
    },
    'Diabete': {'in_db': './internal/ml/model_selection/exp_result_sever_cache_sql_indb_b64/'
    ...
    'Criteo': {'in_db': './internal/ml/model_selection/exp_result_sever_cache_sql_indb_b64/'
