...
frappe_datasets_result = {
    r"500 $m$": {
        'out-DB-cpu': './internal/ml/model_selection/exp_result_sever_cache_sql_scale/'
                      '/time_score_mlp_sp_criteo_batch_size_64_cpu_jacflow_500.json',
        'In-Db-opt': './internal/ml/model_selection/exp_result_sever_cache_sql_indb_scale/'
                     '/time_score_mlp_sp_criteo_batch_size_32_cpu_jacflow_500.json',
    },

    r"1k $m$": {'out-DB-cpu': './internal/ml/model_selection/exp_result_sever_cache_sql_scale/'
                              '/time_score_mlp_sp_criteo_batch_size_64_cpu_jacflow_1k.json',
                'In-Db-opt': './internal/ml/model_selection/exp_result_sever_cache_sql_indb_scale/'
                             '/time_score_mlp_sp_criteo_batch_size_32_cpu_jacflow_1k.json'},
    r"2k $m$": {'out-DB-cpu': './internal/ml/model_selection/exp_result_sever_cache_sql_scale/'
                              '/time_score_mlp_sp_criteo_batch_size_64_cpu_jacflow_2k.json',
                'In-Db-opt': './internal/ml/model_selection/exp_result_sever_cache_sql_indb_scale/'
                             '/time_score_mlp_sp_criteo_batch_size_32_cpu_jacflow_2k.json'},

    r"4k $m$": {'out-DB-cpu': './internal/ml/model_selection/exp_result_sever_cache_sql_scale/'
