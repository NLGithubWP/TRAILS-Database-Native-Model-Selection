...
def run_with_time_budget(time_budget: float):
    ...
    return best_arch, best_arch_performance, score_his
...
if __name__ == "__main__":
    ...
    checkpoint_name = f"./exps/main_v2/analysis/p1_score_auc/" \
                      f"res_end_2_end_{args.dataset}_{args.kn_rate}_{args.num_points}_test.json"
    if only_phase1:
        checkpoint_name = f"./exps/main_v2/analysis/p1_score_auc/" \
    ...
    for run_id in range(total_run):
        ...
        for time_budget in budget_array:
            ...
            best_arch, best_arch_performance, score_his = run_with_time_budget(time_budget_sec)
