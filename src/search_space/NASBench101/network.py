...
from search_space.NASBench101.primitives import *
...
class NasBench101Network(Architecture):

    def __init__(self, spec_matrix, ops_matrix, args):
        super(Architecture, self).__init__()

        spec = NASBench101ModelSpec(spec_matrix, ops_matrix)
