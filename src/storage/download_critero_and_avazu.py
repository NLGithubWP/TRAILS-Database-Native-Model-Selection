...
if __name__ == "__main__":
    ...
    download('https://worksheets.codalab.org/rest/bundles/0x8dca5e7bac42470aa445f9a205d177c6/contents/blob/', '../firmest_data/data/structure_data/criteo/criteo.zip')
