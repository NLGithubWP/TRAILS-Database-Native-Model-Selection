...
# 0.6457916844782529
with open("//result/CIFAR10_15625/vote_res/201_15625_c10_128_unionBest_withvote.json", 'r') as readfile:
    data_rank = json.load(readfile)

# 0.792567673818
with open("//result/CIFAR10_15625/vote_res/201_15625_c10_128_unionBest.json", 'r') as readfile:
