...
with open('/Users/kevin/project_python/Fast-AutoNAS/result/CIFAR10_15625/vote_res/101_15625_c10_128_unionBest_withvote.json', 'r') as readfile:
...
for i, ele in enumerate(np.array_split(list(visited.keys()), 8)):
    ...
    with open("/Users/kevin/project_python/Fast-AutoNAS/result/CIFAR10_15625/101_correct_pair/partition-"+str(i), 'w') as outfile:
